  ...
  for (let m of menus) {
    ...
    if (m.node_type === GLBConfig.NODE_TYPE.NODE_ROOT) {
      ...
      return_list.push({
        systemmenu_id: m.systemmenu_id,
        systemmenu_name: m.systemmenu_name,
        systemmenu_mobile_icon: m.systemmenu_mobile_icon,
        systemmenu_mobile_backcolor: m.systemmenu_mobile_backcolor,
        api_id: m.api_id,
        api_path: m.api_path,
...
exports.addMenuAct = async req => {
  ...
  if (afolder || aapi || tapi) {
    ...
    await tb_common_systemmenu.create({
      ...
      parent_id: doc.parent_id,
      systemmenu_mobile_icon: doc.systemmenu_mobile_icon,
      systemmenu_mobile_backcolor: doc.systemmenu_mobile_backcolor
    })
  }
...
exports.modifyMenuAct = async req => {
  ...
  if (menum) {
    ...
    if (api) {
      ...
      api.systemmenu_mobile_icon = doc.systemmenu_mobile_icon
      api.systemmenu_mobile_backcolor = doc.systemmenu_mobile_backcolor
      await api.save()
